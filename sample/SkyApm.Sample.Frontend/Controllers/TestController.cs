    ...
    public class TestController : Controller
    {
        ...
        public Task<string> Background()
        {
            return Timing(async () =>
            {
                ...
                //new DiagnosticFunc<Task>(SkyApmCategory.FORK, () => BackendDelayAsync(3000)).Invoke();
                await BackendDelayAsync(300);
            });
        }
        ...
        public Task<string> BackgroundTimeout()
        {
            return Timing(async () =>
            {
                ...
                //new DiagnosticFunc<Task>(SkyApmCategory.FORK, () => BackendDelayAsync(10000)).Invoke();
                await BackendDelayAsync(300);
            });
        }
        ...
        public Task<string> BgTask()
        {
            return Timing(async () =>
            {
                ...
                //Task.Run(new DiagnosticFunc<Task>(SkyApmCategory.FORK, async () => await BackendDelayAsync(3000)));
                await BackendDelayAsync(300);
            });
        }
        ...
        public Task<string> BgThread()
        {
            return Timing(async () =>
            {
                ...
                //new Thread(new DiagnosticThreadStart(SkyApmCategory.FORK, () => BackendDelayAsync(3000).GetAwaiter().GetResult())).Start();
                await BackendDelayAsync(300);
            });
        }
        ...
        public Task<string> BgThreadPool()
        {
            return Timing(async () =>
            {
                ...
                //ThreadPool.QueueUserWorkItem(new DiagnosticWaitCallback(SkyApmCategory.FORK, state => BackendDelayAsync(3000).GetAwaiter().GetResult()));
                await BackendDelayAsync(300);
            });
        }
        ...
        public Task<string> BgTimer()
        {
            return Timing(async () =>
            {
                ...
                //var timer = new Timer(new DiagnosticTimerCallback(SkyApmCategory.FORK, state => BackendDelayAsync(3000).GetAwaiter().GetResult()));
        ...
        public Task<string> DelayStart()
        {
            return Timing(async () =>
            {
                ...
                //Task.Run(new DiagnosticFunc<Task>(SkyApmCategory.FORK, async () =>
                //{
                //    await Task.Delay(10000);
                //    await BackendDelayAsync(200);
                //}));
        ...
        {
            Task.Run(new DiagnosticTaskFunc(SkyApmCategory.WEAKEN_CONTEXT, async () =>
            {
                while (true)
                {
